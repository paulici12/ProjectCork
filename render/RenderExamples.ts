...
class RenderExamples
{
    ...
    private loadShader(gl: WebGLRenderingContext, shader_type: number, source: string)
    {
    ...
    public test(gl: WebGLRenderingContext)
    {
    ...
    private drawScene(gl: WebGLRenderingContext, programInfo: any, buffers: any)
    {
        ...
        //    const data_type: number = gl.FLOAT;    // the data in the buffer is 32bit floats
